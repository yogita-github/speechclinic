  ...
  return (
    <>
      ...
      <div className="Navigation_tab">
        ...
        <div className="paragraph_navi">
          <h4 >
            Address:Rajshri Speech & Hearing Clinic ,Shop No 7, Balaji Sankul, in
            front of Dr. Babasaheb Ambedkar Udyan, near Khwajamia Dargah, Ganesh
            Colony, Jalgaon, Maharashtra 425001.
          </h4>
        </div>
        <div className="iframe_navi">
          <iframe
